...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "scope_key", sa.String(length=80), server_default="internal", nullable=False
        ),
        sa.Column("requested_by_user_id", sa.Integer(), nullable=True),
        sa.Column("parent_job_id", sa.Integer(), nullable=True),
        sa.Column("job_type", sa.String(length=64), nullable=False),
        sa.Column(
            "worker_type", sa.String(length=32), server_default="server", nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "attempt_number >= 1", name="ck_job_attempts_number_positive"
        ),
        sa.ForeignKeyConstraint(["job_id"], ["jobs.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        "ix_job_events_job_created", "job_events", ["job_id", "created_at", "id"]
    )
